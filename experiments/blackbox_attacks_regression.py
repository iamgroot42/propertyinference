...
from distribution_inference.attacks.blackbox.utils import _get_preds_for_vic_and_adv, get_attack
...
if __name__ == "__main__":
    ...
    for _ in range(attack_config.tries):
        ...
        for prop_value in attack_config.values:
            ...
            models_vic_ = ds_vic_specific.get_models(
                train_config,
            ...
            if type(models_vic_) == tuple:
                models_vic_ = models_vic_[0]
            models_vic.append(models_vic_)

            models_adv_ = ds_adv_specific.get_models(
                train_adv_config,
            ...
            if type(models_adv_) == tuple:
                models_adv_ = models_adv_[0]
            models_adv.append(models_adv_)
        ...
        if are_graph_models:
            ...
            if make_processed_version:
                ...
                loader_adv = ds_D0.get_processed_val_loader(
                    batch_size=bb_attack_config.batch_size)
            else:
        ...
        # attack_name = attack_config.black_box.attack_type
        attack_name = "att_ratio"
        attacker_obj = get_attack(attack_name)(bb_attack_config)
        # Execute attack
        ...
        for l, c in zip(test_labels, chosen_mse):
            logger.add_results(attack_name, l, c, None)
